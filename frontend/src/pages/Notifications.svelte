    ...
    >
      <div class="flex-1">
        ...
        <div class="flex items-center gap-2 mt-1">
          <span
            class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-cyan-100 text-cyan-700 text-xs font-bold"
          >
          ...
          <span class="text-xs text-slate-400 font-medium"
            >• Showing all alerts</span
          >
        </div>
      </div>
      <div class="flex items-center gap-2.5 sm:shrink-0">
        <button
          class="flex-1 sm:flex-none px-4 py-2.5 rounded-xl text-sm font-bold border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all active:scale-95 shadow-sm"
          onclick={toggleUnreadOnly}
        >
          {showUnreadOnly ? "Show All" : "Show Unread"}
        </button>
        <button
          class="flex-1 sm:flex-none px-4 py-2.5 rounded-xl text-sm font-bold bg-slate-900 text-white hover:bg-slate-800 disabled:opacity-60 transition-all active:scale-95 shadow-lg shadow-slate-900/10"
