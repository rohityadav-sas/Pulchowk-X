    ...
    >
      ...
      >
        ...
        {:else}
          ...
          {#if isLoading}
            <div class="flex justify-start items-end gap-2 px-1">
              <div
                class="w-6 h-6 rounded-lg flex items-center justify-center shrink-0 mb-1"
                style="background: linear-gradient(135deg, #667EEA, #764BA2);"
              >
                <svg
              ...
              <div
                class="px-4 py-3 rounded-2xl rounded-bl-none bg-slate-100 flex items-center h-[38px]"
              >
